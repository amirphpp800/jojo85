...
function getCountryNameFromCode(code) {
  const map = {
    // آمریکا و کانادا
    'US': 'آمریکا', 'CA': 'کانادا', 'MX': 'مکزیک',
    // اروپای غربی
    'GB': 'انگلستان', 'DE': 'آلمان', 'FR': 'فرانسه', 'NL': 'هلند', 'BE': 'بلژیک',
    ...
    // اروپای شرقی
    'PL': 'لهستان', 'CZ': 'چک', 'SK': 'اسلواکی', 'HU': 'مجارستان', 'RO': 'رومانی',
    'BG': 'بلغارستان', 'UA': 'اوکراین', 'BY': 'بلاروس', 'MD': 'مولداوی',
    'RS': 'صربستان', 'HR': 'کرواسی', 'SI': 'اسلوونی', 'BA': 'بوسنی', 'MK': 'مقدونیه',
    'AL': 'آلبانی', 'ME': 'مونته‌نگرو', 'XK': 'کوزوو',
    // روسیه و همسایگان
    'RU': 'روسیه', 'KZ': 'قزاقستان', 'UZ': 'ازبکستان', 'TM': 'ترکمنستان',
    'KG': 'قرقیزستان', 'TJ': 'تاجیکستان', 'AM': 'ارمنستان', 'AZ': 'آذربایجان', 'GE': 'گرجستان',
    // خاورمیانه
    'IR': 'ایران', 'TR': 'ترکیه', 'AE': 'امارات', 'SA': 'عربستان', 'IL': 'اسرائیل',
    'IQ': 'عراق', 'SY': 'سوریه', 'JO': 'اردن', 'LB': 'لبنان', 'PS': 'فلسطین',
    'KW': 'کویت', 'QA': 'قطر', 'BH': 'بحرین', 'OM': 'عمان', 'YE': 'یمن', 'CY': 'قبرس',
    // آفریقا
    'EG': 'مصر', 'ZA': 'آفریقای جنوبی', 'NG': 'نیجریه', 'KE': 'کنیا', 'ET': 'اتیوپی',
    'GH': 'غنا', 'TZ': 'تانزانیا', 'UG': 'اوگاندا', 'DZ': 'الجزایر', 'MA': 'مراکش',
    'TN': 'تونس', 'LY': 'لیبی', 'SD': 'سودان', 'SN': 'سنگال', 'CI': 'ساحل عاج',
    // آسیای شرقی
    ...
    'TL': 'تیمور شرقی',
    // جنوب آسیا
    'IN': 'هند', 'PK': 'پاکستان', 'BD': 'بنگلادش', 'LK': 'سریلانکا', 'NP': 'نپال',
    'BT': 'بوتان', 'MV': 'مالدیو', 'AF': 'افغانستان',
    // اقیانوسیه
    'AU': 'استرالیا', 'NZ': 'نیوزیلند', 'FJ': 'فیجی', 'PG': 'پاپوآ گینه نو',
    // آمریکای جنوبی
    'BR': 'برزیل', 'AR': 'آرژانتین', 'CL': 'شیلی', 'CO': 'کلمبیا', 'PE': 'پرو',
    'VE': 'ونزوئلا', 'EC': 'اکوادور', 'BO': 'بولیوی', 'PY': 'پاراگوئه', 'UY': 'اروگوئه',
    'GY': 'گویان', 'SR': 'سورینام',
    // آمریکای مرکزی و کارائیب
    'CR': 'کاستاریکا', 'PA': 'پاناما', 'GT': 'گواتمالا', 'HN': 'هندوراس', 'SV': 'السالوادور',
    'NI': 'نیکاراگوئه', 'BZ': 'بلیز', 'CU': 'کوبا', 'JM': 'جامائیکا', 'HT': 'هائیتی',
    'DO': 'جمهوری دومینیکن', 'TT': 'ترینیداد و توباگو', 'BS': 'باهاما', 'BB': 'باربادوس'
  };
